...
export default function About() {
  return (
    <section id="about" className="py-16 md:py-24 bg-white relative">
      <div className="absolute right-5 md:right-10 bottom-10 opacity-30">
        <Image src="/assets/icons/question-sign-hand-drawn-outline-svgrepo-com.svg" alt="Question mark decorative background" width={128} height={128} className="w-20 h-20 md:w-32 md:h-32" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative z-10">
        ...
        >
          ...
          <div className="text-lg sm:text-2xl md:text-3xl text-black/80 leading-relaxed font-ultra">
            ...
            <span className="block mt-3 sm:mt-0">We combine engineering, design, and AI to deliver solutions that solve real business problems.</span>
          </div>
        </motion.div>
      </div>
    </section>
