          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 w-full md:w-auto">
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href="/about" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">About Us</Link></li>
                <li><Link href="/contact" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">Contact</Link></li>
                <li><Link href="/services" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">All Services</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href="/software-development" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">Software Development</Link></li>
                <li><Link href="/mobile-app-development" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">Mobile App Development</Link></li>
                <li><Link href="/cloud-infrastructure" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">Cloud Infrastructure</Link></li>
                <li><Link href="/technology-consulting" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">Technology Consulting</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="mailto:hello@esvincreative.in" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">
                    hello@esvincreative.in
                  </a>
                </li>
                <li>
                  <a href="https://esvincreative.in" target="_blank" rel="noopener noreferrer" className="text-lg font-ultra text-black/70 hover:text-black transition-colors">
                    esvincreative.in
                  </a>
                </li>
                <li>
