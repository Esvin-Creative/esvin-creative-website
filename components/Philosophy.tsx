...
export default function Philosophy() {
  return (
    <section className="py-24 px-6 md:px-12 bg-white border-y-2 border-dashed border-black relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="bg-gray-50 p-8 sketch-border sketch-shadow">
            <h3 className="text-2xl font-bold font-ultra text-black mb-4">Architecture Over Frameworks</h3>
          ...
          <div className="bg-highlight-pink/10 p-8 sketch-border sketch-shadow">
            <h3 className="text-2xl font-bold font-ultra text-black mb-4">Eliminating Vendor Fragmentation</h3>
            <p className="text-lg font-ultra text-black/80 leading-relaxed">
